...
namespace BackToBasics.Helpers
{
    ...
    {
        public static void CallInterfaces()
        {
            InterfacesTester();
        }

        public static void CallKeyValuePair()
        {
            KeyValuePairsTester();
        }

        public static void CallBehavioral()
        {
            //--Behavioral
            IteratorTester();//+
            ObserverTester();//+
        ...
        public static void CallCreational()
        {
            //--Creational
            SingletonTester();//+
            FactoryTester();//+
        ...
        public static void CallStructural()
        {
            //--Structural
            FacadeTester();//+
            ProxyTester();//+
